...
const Section1 = () => {
  return (
    <div className="relative mx-auto mb-10 w-[375px]">
      {/*Utility images */}
      <Image
        src="/utilitiy-images/oval.svg"
        className="w-[300px] h-[250px] ml-[-140px] mt-[50px] absolute scale-[150%] |tablet->| md:scale-[100%] md:ml-[-390px] md:scale-y-[200%] md:mt-[50px]"
        width={300}
        height={250}
      />
      ...
      <div className=" w-[250px] h-[350px] mx-auto mt-[0px] |tablet->| relative md:w-[441px] md-h-[600px] md:left-[200px] ">
        <Image
          ...
          className="dark:bg-slate-800/50 w-[250px] h-[344px] z-40 absolute |tablet->| md:w-[441px] md:h-[600px] md:z-[0]"
          width={125}
          height={150}
        />
      </div>
      ...
      <div className=" flex flex-col  space-y-5  w-[355px] |tablet->| md:relative md:right-[170px]   md:top-[-200px] md:w-[490px] ">
        <div className="font-Grotesk font-bold text-center text-[40px] |tablet->| md:text-[50px]">
